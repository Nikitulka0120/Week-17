...
4. **Database Init (db-init)** - init-контейнер для создания таблиц и заполнения базы начальными данными перед запуском бэкенда.
5. **PostgreSQL (:5432)** - реляционная база данных для хранения информации о товарах.
